    ...
    return (
        <nav
            ...
            className={`${isScrolled && "bg-opacity-[0.5] shadow-md drop-shadow-lg"
                } font-medium duration-500 bg-opacity-50 transition-all linear z-40 dark:text-white w-[90%] md:w-[90%] lg:w-[90%] xl:w-[100%]  max-w-7xl  mx-auto bg-gray-100 dark:bg-[#35353579] ${open && "dark:bg-[#000] bg-opacity-100"
